<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gkstart.aspx.cs" Inherits="onlineexamsystem.gkstart" %>
...
<body style="background-image:url('../image/gk.jpg')">
    <form id="form2" runat="server" style="width:100%;height:500px">
        <div id="only" class="auto-style1" style="border-radius: 15px 50px;background-color:white;">
            ...
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="auto-style4">GENERAL KNOWLEDGE EXAM</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <br />
                <br />
